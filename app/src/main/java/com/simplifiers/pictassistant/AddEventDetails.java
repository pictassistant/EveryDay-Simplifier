...
public class AddEventDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newPostImage = findViewById(R.id.imageView_add1);
        newPostDesc  = findViewById(R.id.new_post_desc1);
        newPostBtn   = findViewById(R.id.button_addmenu1);
        newPostProgress = findViewById(R.id.new_post_progress1);
                                    ...
                                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                        ...
                                        firebaseFirestore.collection("Events").add(postMap).addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                                            ...
                                            public void onComplete(@NonNull Task<DocumentReference> task) {
                                                if(task.isSuccessful()){
                                                    Toast.makeText(AddEventDetails.this, "Post Added", Toast.LENGTH_SHORT).show();
                                                    Intent mainIntent = new Intent(AddEventDetails.this,Main2Activity.class);
                                                    startActivity(mainIntent);
                                                    finish();
                                                }
                                                else{
                                                    Toast.makeText(AddEventDetails.this, "Task Failed", Toast.LENGTH_SHORT).show();
                                                }

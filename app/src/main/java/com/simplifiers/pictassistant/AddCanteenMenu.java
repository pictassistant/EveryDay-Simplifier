...
public class AddCanteenMenu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newPostImage = findViewById(R.id.imageView_add);
        newPostDesc  = findViewById(R.id.new_post_desc);
        newPostBtn   = findViewById(R.id.button_addmenu);
                            ...
                            if (task.isSuccessful()) {
                                ...
                                uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                                    ...
                                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                        ...
                                        firebaseFirestore.collection("Canteen").add(postMap).addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                                            @Override
                                            public void onComplete(@NonNull Task<DocumentReference> task) {
                                                if(task.isSuccessful()){
                                                    Toast.makeText(AddCanteenMenu.this, "Post Added", Toast.LENGTH_SHORT).show();
                                                    Intent mainIntent = new Intent(AddCanteenMenu.this,Main2Activity.class);
                                                    startActivity(mainIntent);
                                                    finish();
                                                }
                                                else{
                                                    Toast.makeText(AddCanteenMenu.this, "Task Failed", Toast.LENGTH_SHORT).show();
                                                }
